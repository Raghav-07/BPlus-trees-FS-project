...
%>
<%
String obj6= request.getParameter("eleven") ;
request.getParameter("pass") ;

String obj7= request.getParameter("thirteen") ;
request.getParameter("pass") ;
String mad=obj7.toString();
String hap=obj6.toString();

String str=obj6.toString();
int sum=Integer.parseInt(str);
newbplus nb=new newbplus();
try {
String gb=nb.method123(sum);

paradise p=new paradise();
paradise pp=new paradise();
String rtt=gb.substring(0, gb.length() - 2);
p.modifyFile("C:\\Users\\ragha\\eclipse-workspace\\demoapp\\WebContent\\data.txt",rtt,mad);
pp.modifyFile("C:\\Users\\ragha\\eclipse-workspace\\demoapp\\WebContent\\info.txt",hap,("U"+mad));
